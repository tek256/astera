...
#define LINMATH_H_DEFINE_VEC(n)                                                \
  ...
  LINMATH_H_FUNC void vec##n##_clear(vec##n dst) {                             \
    for (int i = 0; i < n; ++i) {                                              \
      dst[i] = 0.f;                                                            \
    }                                                                          \
  }                                                                            \
...
LINMATH_H_FUNC void vec3_set(vec3 v, float x, float y, float z) {
  v[0] = x;
  v[1] = y;
  v[2] = z;
}

LINMATH_H_FUNC void vec4_set(vec4 v, float x, float y, float z, float w) {
  v[0] = x;
  v[1] = y;
  v[2] = z;
  v[3] = w;
